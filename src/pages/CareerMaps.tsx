                ...
                {careerMaps.map((map, index) => (
                  <li key={index}>
                    <a
                      ...
                      className="group flex items-center justify-between p-6 lg:p-8 transition-all duration-300 hover:bg-primary/5" 
                    >
                      
                      <div className="flex flex-1 items-start gap-5 lg:gap-8"> 
