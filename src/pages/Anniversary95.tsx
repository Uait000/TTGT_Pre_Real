...
const Anniversary95 = () => {
    ...
    return (
        <MainLayout>
                ...
                <div className="space-y-16 sm:space-y-20">
                    ...
                    {renderPostContent(1, "Этапы нашей истории",
                        <>
                            ...
                            <p className="mb-4">Виктор Фёдорович Иванов поступил в наш техникум в 1933 году... (полный текст)</p>
                            <p className="mb-4">Рассказывая о своих преподавателях, Виктор Фёдорович с теплом о них отзывался... (полный текст)</p>
                    ...
                    {renderPostContent(2, "Ими гордимся: Плотников Василий Петрович",
                        <>
                            ...
                            <p className="mb-4">Во время войны он воевал, а в мирное время 35 лет преподавал математику... (полный текст)</p>
                            <p className="mb-4">Василий Плотников родился 27 марта 1919 года... (полный текст)</p>
                            <p className="mb-4">В сентябре 1942 года Плотников В.П. был призван в армию... (полный текст)</p>
                            <p className="mb-4">В мае 1946 года Плотников В.П. был демобилизован... (полный текст)</p>
                            <p className="mb-4">Бывшие его воспитанники добрым словом вспоминают своего учителя...</p>
                            <p>Татарян Артур, студент 4-го курса... (полный текст)</p>
                        </>,
                    ...
                    {renderPostContent(3, "Ими гордимся: Бутов Николай Васильевич",
                        <>
                            ...
                            <p className="mb-4">Жизненный путь Николая Васильевича Бутова - гордость Тихорецкого техникума... (полный текст)</p>
                            <p className="mb-4">Родился Николай Бутов в 1916 году... (полный текст)</p>
                            <p className="mb-4">Всю войну прослужил в войсках НКВД... (полный текст)</p>
                            <p className="mb-4">В 1946 году Николай Васильевич демобилизовался... (полный текст)</p>
                            <p className="mb-4">Николай Васильевич обладал организаторским способностям... (полный текст)</p>
                            <p className="mb-4">С июля 1977 года - перешёл на преподавательскую работу... (полный текст)</p>
                            <p>За свои заслуги Бутов Николай Васильевич награждён орденом «Трудового Красного Знамени»... (полный текст)</p>
                        </>,
                    ...
                    {renderPostContent(4, "Первый выпуск женщин-помощников машинистов",
                        <>
                            ...
                            <p className="mb-4">Тихорецкий техникум железнодорожного транспорта – филиал ФГБОУ ВО РГУПС был основан в октябре 1930 года... (полный текст)</p>
                            <p className="mb-4">В стране быстрыми темпами шла индустриализация... (полный текст)</p>
                            <p className="mb-4">В годы Великой Отечественной войны многие женщины... (полный текст)</p>
                            <p className="mb-4">На общем фото 1-го выпуска женщин помощников машинистов... (полный текст)</p>
                            <p>Ветеран труда Тихорецкого локомотивного депо Анна Кузьминична Подгорная... (полный текст)</p>
                        </>,
            ...
            {/* Модальное окно для увеличения (оно должно быть частью страницы, не макета) */}
