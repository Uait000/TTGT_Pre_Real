...
const DocLink = ({ href, text }: { href: string, text: string }) => (
    <a
        ...
        className="flex items-center justify-between p-2 pl-4 bg-white rounded border border-border hover:shadow-md hover:border-primary/50 transition-all duration-200"
    >
...
const StartInScience = () => {
    const documents2025 = [
        { name: 'Положение о проведении VIII региональной студенческой исследовательской конференции (с международным участием) посвящённой Десятилетию науки и технологий в Российской Федерации «Старт в науку»', url: '#' },
    ...
    const documents2024 = [
        { name: 'ВНИМАНИЕ! Конференция переносится на 8 - 9 апреля 2024 года', url: '#', isAlert: true },
    ...
    const documents2023Main = [
        ...
        { name: 'СПИСОК ПОДАВШИХ ДОКУМЕНТЫ ДЛЯ УЧАСТИЯ', url: '#' },
                        ...
                        <AccordionContent className="px-6 pb-6">
                            <div className="space-y-6">
                                            ...
                                            <div key={nomIndex} className="bg-gradient-to-r from-primary/5 to-secondary/5 rounded-lg p-5 border border-border">
                                                ...
                                                <div className="space-y-2 mb-3">
                                                    {nomination.experts.map((expert, expertIndex) => (
                                                        <DocLink key={expertIndex} href={expert.url} text={expert.name} />
                                                    ))}
                                                </div>
                                                <a
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="block p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
                                >
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3 flex-1">
                                            <FileText className="w-5 h-5 text-green-600 flex-shrink-0" />
                                            <span className="text-green-800 font-medium text-sm">Сборник тезисов работ участников VI региональной студенческой исследовательской конференции</span>
                                        </div>
